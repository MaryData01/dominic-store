...
const Contact = () => {
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center p-4 text-center max-w-4xl mx-auto py-16">
      ...
      >
        <Mail className="w-20 h-20 text-brand-cyan mb-6" />
        ...
        <p className="font-body text-lg text-text-secondary max-w-lg mb-6">
          Reach out to Dominic Store directly. We are happy to help!
        </p>
        <div className="bg-bg-surface border border-bg-border rounded-xl p-8 text-left w-full max-w-2xl mb-10">
          <h3 className="font-display font-bold text-xl text-text-primary mb-3">Email Support</h3>
          <p className="font-body text-text-secondary mb-6">Send us an email at <span className="text-brand-cyan hover:underline cursor-pointer">support@dominicstore.com</span>. We aim to respond within 24 business hours.</p>
          <h3 className="font-display font-bold text-xl text-text-primary mb-3">Location</h3>
          <p className="font-body text-text-secondary">Lagos, Nigeria.</p>
        </div>
        <Link 
          to="/" 
